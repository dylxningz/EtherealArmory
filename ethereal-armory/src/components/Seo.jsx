...
export default function Seo({
  ...
  useEffect(() => {
    ...
    if (omitSocial) {
      document.head.querySelectorAll('meta[property^="og:"], meta[name^="twitter:"]')
        .forEach((element) => element.remove());
    } else {
      upsertMeta('meta[property="og:site_name"]', { property: "og:site_name", content: "Ethereal Armory" });
  ...
  }, [description, image, noIndex, omitCanonical, omitSocial, path, structuredData, title, type]);
